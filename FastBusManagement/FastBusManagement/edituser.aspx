<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="edituser.aspx.cs" Inherits="FastBusManagement.edituser" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <h3 id="member1">STUDENT DETAILS:</h3>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" OnTextChanged="TextBox5_TextChanged"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col">
                                <br />
                                <div class="form-group">
                                     <asp:Button class="btn btn-warning btn-block btn-lg" ID="Button2" runat="server" Text="EDIT USER INFORMATION" OnClick="Button2_Click" />
