...
{
    public partial class studentpassforget : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Update Student SET  Password = '" + TextBox2.Text.Trim() + "' Where Username= '" + TextBox1.Text.Trim() + "'", con);
